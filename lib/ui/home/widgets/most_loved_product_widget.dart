...
class MostLovedProductWidgets extends StatefulWidget {
  final productName;
  final description;
  final price;
  final cuttedPrice;
  ...
  @override
  State<MostLovedProductWidgets> createState() => _MostLovedProductWidgetsState();
}

class _MostLovedProductWidgetsState extends State<MostLovedProductWidgets> {
  @override
